% look for over critical solutions, beta0 > beta0_cr
function T = create_345_030(T)
...
function vm = vmInit()
% initial parameter for mc² = 346 keV (over critical)
opts	= struct('xmin', 1E-5, 'xmax', 1E20, 'tau', 1E-16, 'rtau', 1E-4);
param	= struct('beta0', 0.006005810057258, 'theta0', 49.058131870416027,	'W0', 78.897187487855192);
