...
EXPORT.dnudlnr = module.ProfileMapping(...
	@(obj) real((obj.data.mass + obj.data.radius.^3.*obj.data.pressure)./(1 - obj.data.mass./obj.data.radius)./obj.data.radius),...
	'{\rm d}\nu/{\rm d}\ln r'...
);
...
EXPORT.velocitySOS = module.ProfileMapping(...
	@(obj) obj.data.pressure.*obj.data.radius.^3./obj.data.mass,...
	'\varsigma(r)'...
);
